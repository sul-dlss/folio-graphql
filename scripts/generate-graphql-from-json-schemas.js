...
const queryType = new GraphQLObjectType({
  ...
  fields: () => {
    ...
    for (const [path, type] of context.types.entries()) {
      ...
      if (['Patron', 'User', 'PatronGroup', 'Instance', 'InstanceNoteType', 'InstanceStatus', 'InstanceType', 'HoldingsRecord', 'Item', 'ItemDamagedStatus', 'LoanPolicy', 'RequestPolicy', 'Library', 'Loan', 'LoanType', 'CallNumberType', 'PatronGroup', 'Block', 'Account', 'ManualBlock', 'PatronBlockCondition', 'PatronBlockLimit', 'FeeFine', 'ProxyFor', 'FixedDueDateSchedule'].includes(type.name)) {
