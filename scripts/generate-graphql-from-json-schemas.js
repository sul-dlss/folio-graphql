...
const refAliases = {
  '/mod-circulation/ramls/schema/call-number-components.json': '/mod-inventory-storage/ramls/schemas/common/callNumberComponents.json',
  '/mod-feesfines/ramls/servicepoint.json': '/mod-inventory-storage/ramls/schemas/service-points/servicepoint.json',
  // Point all holdingsRecord(s) to the root inventory storage versions (/mod-inventory-storage/ramls/holdingsRecord.json)
  '/mod-inventory-storage/ramls/schemas/item-storage/holdingsrecord.json': '/mod-inventory-storage/ramls/schemas/holdings-storage/holdingsRecord.json',
  '/mod-circulation/ramls/service-point.json': '/mod-inventory-storage/ramls/schemas/service-points/servicepoint.json',
  ...
  '/mod-circulation-storage/ramls/time-period.json': '/mod-inventory-storage/ramls/schemas/service-points/time-period.json',
  '/mod-courses/ramls/time-period.json': '/mod-inventory-storage/ramls/schemas/service-points/time-period.json',
  '/mod-feesfines/ramls/time-period.json': '/mod-inventory-storage/ramls/schemas/service-points/time-period.json',
...
function fixupStuff(file, json) {
  ...
  if (file.includes('/mod-circulation/ramls/loan.json')) {
    json.properties.item = { "$ref": "/mod-inventory-storage/ramls/schemas/item-storage/item.json" }
  }
  ...
  if (file.includes('/mod-inventory-storage/ramls/schemas/item-storage/item.json')) {
    json.properties.materialType['$ref'] = '/mod-inventory-storage/ramls/schemas/material-types/materialtype.json';
  }

  if (file.includes('/mod-inventory-storage/ramls/schemas/locations/location.json')) {
    json.properties.library['folio:$ref'] = 'loclib.json';
  }

  if (file.includes('/mod-inventory-storage/ramls/schemas/common/identifier.json')) {
    json.properties.identifierTypeObject['folio:$ref'] = 'identifiertype.json';
  }
